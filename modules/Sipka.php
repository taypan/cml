...
if(isset($_GET['text']) && ($_GET['text'] == "doplnky_plain")){return "500px";}
if(isset($_GET['text']) && ($_GET['text'] == "kontakty")){return "600px";}
//---------------------------------------------------
} else{
//---------------------------------------------------
