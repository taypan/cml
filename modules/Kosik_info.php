...
if(isset($_SESSION['shop']) && ((isset($_GET['page']) && $_GET['page'] == "Zbozi") || (isset($_GET['page']) && $_GET['page'] == "Objednat")|| (isset($_GET['page']) && $_GET['page'] == "Feeder")|| (isset($_GET['page']) && $_GET['page'] == "Detail") || (isset($_GET['text']) && $_GET['text'] == "rozcestnik")|| (isset($_GET['text']) && $_GET['text'] == "doplnky"))){
