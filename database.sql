...
--
-- Počítač: localhost
-- Vygenerováno: Pátek 26. února 2010, 23:14
-- Verze MySQL: 5.1.41
-- Verze PHP: 5.2.12-2
...
(38, 'DoplÅˆky a hraÄky', 'index.php?page=Texty&action=show&text=doplnky', 3, 'guest', 'main', ''),
...
(37, 'CAT', 'ÄŒajovÃ© stolky a sety,LoÅ¾nice,Stoly a stolky,PracovnÃ­ stoly a skÅ™Ã­Åˆky,DÄ›tskÃ½ nÃ¡bytek, ZakÃ¡zkovÃ¡ vÃ½roba,HraÄky,Lampy a lampiÄky,DoplÅˆky'),
